...
public class ComponentUtils {
    ...
    public static void enableComponent(String componentCls, boolean enabled) {
        ComponentName componentName = new ComponentName(Loader.getApplication(), componentCls);
        Loader.getApplication().getPackageManager().setComponentEnabledSetting(componentName,
    ...
    public static boolean isComponentEnabled(String componentCls) {
        ComponentName componentName = new ComponentName(Loader.getApplication(), componentCls);
        return Loader.getApplication().getPackageManager().getComponentEnabledSetting(componentName)
